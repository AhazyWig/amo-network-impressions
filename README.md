...
У рамках цього тестового відразу візьмемо потрібні дані, вивантажимо їх як як raw таблицю і окремо будемо агрегувати у окрему таблицю.
...
3. PySpark підійде як стабільне рішення для обробки великих даних та для складних трансформацій.
